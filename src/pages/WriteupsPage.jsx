...
function Tag({ children }) {
  return (
    <span style={{
      fontFamily: 'JetBrains Mono', fontSize: 9, color: 'var(--meta-text)',
  ...
  return (
    <a href={`#/writeups/${w.slug}`} style={{
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 10, flexWrap: 'wrap', marginBottom: 6 }}>
        ...
        {w.source?.platform && (
          <span style={{ fontFamily: 'JetBrains Mono', fontSize: 9.5, color: 'var(--text-faintest)' }}>
            · {w.source.platform}
          </span>
        )}
      </div>
      <h3 style={{
        ...
        color: 'var(--text-strong)', marginBottom: 7, lineHeight: 1.35,
      }}>
        {w.title}
      </h3>
      <p style={{
        fontFamily: 'Inter, sans-serif', fontSize: 13, lineHeight: 1.65, color: 'var(--text-muted)',
        marginBottom: 12,
      }}>
        {w.summary}
      </p>
...
function WriteupsIndex() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6" style={{ paddingTop: 120, paddingBottom: 96 }}>
      ...
      {items.length === 0 ? (
        <p style={{ fontFamily: 'JetBrains Mono', fontSize: 12, color: 'var(--text-dim)', lineHeight: 1.8 }}>
  ...
  if (!w) {
    return (
      <div className="max-w-3xl mx-auto px-6" style={{ paddingTop: 120, paddingBottom: 96 }}>
        ...
        <p style={{ fontFamily: 'JetBrains Mono', fontSize: 12, color: 'var(--text-dim)' }}>
  ...
  return (
    <article className="max-w-3xl mx-auto px-6" style={{ paddingTop: 120, paddingBottom: 96 }}>
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center', marginBottom: 10 }}>
        ...
        {w.updated && (
          <span style={{ fontFamily: 'JetBrains Mono', fontSize: 10, color: 'var(--text-faintest)' }}>
      ...
      {loadError ? (
        <div style={{
          border: '1px solid var(--danger-bg)', background: 'rgba(239,68,68,0.05)',
          borderRadius: 8, padding: '16px 18px',
        }}>
          <p style={{ fontFamily: 'JetBrains Mono', fontSize: 12, color: 'var(--danger-soft)', lineHeight: 1.7 }}>
          ...
          <button
            ...
            style={{
              marginTop: 12, background: 'none', border: '1px solid var(--danger-bg)',
              color: 'var(--danger-soft)', borderRadius: 4, padding: '7px 14px',
        ...
        <p style={{ fontFamily: 'JetBrains Mono', fontSize: 11, color: 'var(--text-faint)' }}>Loading…</p>
      ) : (
